...
public class SignupThree  extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-4050");
        ...
        c7 = new JCheckBox("I hereby declares that above entered details are correct to the best of the my Knownledge");
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == submit){
            ...
            String cardnumber = "" + Math.abs((random.nextLong() % 90000000L) + 1155072400000000L);
